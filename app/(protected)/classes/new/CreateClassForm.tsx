...
export default function CreateClassForm({ instructors, levels }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mt-6 max-w-lg space-y-4">
      ...
      <div>
        ...
        <select id="day_of_week" name="day_of_week" required className="input">
          {DAYS.map((d) => (
      ...
      <div>
        ...
        <input id="location" name="location" type="text" required className="input" />
      </div>
      ...
      <div>
        ...
        <select id="instructor_id" name="instructor_id" required className="input">
